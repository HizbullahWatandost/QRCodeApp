...
public class ScannedGeneralQRCodeAdapter extends RecyclerView.Adapter<ScannedGeneralQRCodeAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.timestamp.setText(formatDate(generalQrScan.getTimestamp()));
    }
