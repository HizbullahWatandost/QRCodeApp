...
/**
 * The GeneratedPaymentQRCodeAdapter is used to populate the generated QR Codes in generated payment QR Code history
 */
public class GeneratedPaymentQRCodeAdapter extends RecyclerView.Adapter<GeneratedPaymentQRCodeAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.timestamp.setText(formatDate(paymentQrGen.getTimestamp()));
    }
