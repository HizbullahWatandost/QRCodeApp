...
public class SecretQRCodeImgDisplay extends AppCompatActivity {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(qrNameEditTxt.getText().toString().trim())) {
                    if (!qr_img_update) {
                        saveNonPaymentQR(convertQRContentToNonPaymentQRGen(qrCreateContent));
                        Toast.makeText(SecretQRCodeImgDisplay.this, "QR Image has been saved successfully", Toast.LENGTH_LONG).show();
                    } else if (qr_img_update) {
                        db.updateGeneratedGeneralSecretQrCode(updateSecretQRCode(secret_qr_id, qrCreateContent));
                        Toast.makeText(SecretQRCodeImgDisplay.this, "QR Code updated successfully!", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(SecretQRCodeImgDisplay.this, "Please enter a name for QR Image", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void saveNonPaymentQR(GeneralQrGen generalQrGen) {
        db.saveSecretQrCode(generalQrGen.getQrCodeContent(), generalQrGen.getQrImg(),
