...
public class GeneralQRScanFavorite extends AppCompatActivity {
    ...
    public void updateScannededQRCode(int qrGenId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRScanFavorite.this, ScannedGeneralQRCodeContentDisplay.class);
    ...
    public void showQRCodeDetails(int QrScanId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRScanFavorite.this, GeneralQRScanDetails.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(GeneralQRScanFavorite.this);
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) GeneralQRScanFavorite.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
