...
public class GeneralQRScanHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generalQrScanList.addAll(db.getAllScannedGeneralSecretQrCodes());
    ...
    private void toggleEmptyPaymentGeneratedQRCode() {
        ...
        if (db.getScannedGeneralSecretQrCodesCount() > 0) {
    ...
    public void updateScannededQRCode(int qrGenId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRScanHistory.this, ScannedGeneralQRCodeContentDisplay.class);
    ...
    public void showQRCodeDetails(int QrScanId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRScanHistory.this, GeneralQRScanDetails.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(GeneralQRScanHistory.this);
        ...
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(GeneralQRScanHistory.this, "Deleted successfully!", Toast.LENGTH_LONG).show();
                    updateRecordListner();
                } catch (Exception e) {
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) GeneralQRScanHistory.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            if (secretQrScanId.getFavoriteQr() == 0) {
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(GeneralQRScanHistory.this, "QR Code added to favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            } else {
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(GeneralQRScanHistory.this, "QR Code removed from favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }
