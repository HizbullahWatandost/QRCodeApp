...
public class QRScannedHistory extends AppCompatActivity {
    ...
    private TextView noQRScannedTxtView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scannedQRList.addAll(db.getAllScannedPaymentQrCodes());

        recyclerView = findViewById(R.id.recycler_vw_qr_codes_holder);
        noQRScannedTxtView = findViewById(R.id.txt_vw_empty_qr_list);
    ...
    private void toggleEmptyPaymentScannedQRCode() {
        ...
        if (db.getScannedPaymentQrCodesCount() > 0) {
            noQRScannedTxtView.setVisibility(View.GONE);
        } else {
            noQRScannedTxtView.setText("Empty Scanned QR Code List!");
            noQRScannedTxtView.setVisibility(View.VISIBLE);
        }
    }
    ...
    public void updateScannedQRCode(int qrScanId, String scannedQRCodeImgName,byte[] qrImg ){
        QRActionPopUp.dismiss();
        Intent intent = new Intent(QRScannedHistory.this, QRScannedUpdateActivity.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(QRScannedHistory.this);
        ...
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try{
                    ...
                    Toast.makeText(QRScannedHistory.this, "Deleted successfully!",Toast.LENGTH_LONG).show();
                    updateRecordListner();
                }catch (Exception e){
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) QRScannedHistory.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            if(qr_scan_index.getFavQrScan() == 0) {
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(QRScannedHistory.this, "QR Code added to favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }else{
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(QRScannedHistory.this, "QR Code removed from favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }
            ...
            detailsBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(QRScannedHistory.this, QRScanResultDisplayActivity.class);
