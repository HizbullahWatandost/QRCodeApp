...
public class SecretQRGenFavorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generalQrGenList.addAll(db.getAllFavGeneratedGeneralSecretQrCodes());
    ...
    private void toggleEmptyPaymentGeneratedQRCode() {
        ...
        if (db.getFavGeneratedGeneralSecretQrCodesCount() > 0) {
            noQRGenTxtView.setVisibility(View.GONE);
        } else {
            noQRGenTxtView.setText("Empty Favorite Generated Secret QR Code List!");
    ...
    public void updateGeneratedQRCode(int qrGenId, int favorite) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(SecretQRGenFavorite.this, SecretQRContentDisplay.class);
    ...
    public void showQRCodeDetails(int qrGenId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(SecretQRGenFavorite.this, SecretQRCodeDetails.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(SecretQRGenFavorite.this);
        ...
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(SecretQRGenFavorite.this, "Deleted successfully!", Toast.LENGTH_LONG).show();
                    updateRecordListner();
                } catch (Exception e) {
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) SecretQRGenFavorite.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            if (non_payment_qr_gen_index.getFavoriteQr() == 0) {
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(SecretQRGenFavorite.this, "QR Code added to favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            } else {
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(SecretQRGenFavorite.this, "QR Code removed from favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }
