...
public class GeneralQRGenHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generalQrGenList.addAll(db.getAllGeneratedGeneralQrCodes());
    ...
    private void toggleEmptyPaymentGeneratedQRCode() {
        ...
        if (db.getGeneratedGeneralQrCodesCount() > 0) {
    ...
    public void updateGeneratedQRCode(int qrGenId, int favorite) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRGenHistory.this, GeneralQRContentDisplay.class);
    ...
    public void showQRCodeDetails(int qrGenId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(GeneralQRGenHistory.this, GeneralQRCodeDetails.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(GeneralQRGenHistory.this);
        ...
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(GeneralQRGenHistory.this, "Deleted successfully!", Toast.LENGTH_LONG).show();
                    updateRecordListner();
                } catch (Exception e) {
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) GeneralQRGenHistory.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            if (non_payment_qr_gen_index.getFavoriteQr() == 0) {
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(GeneralQRGenHistory.this, "QR Code added to favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            } else {
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(GeneralQRGenHistory.this, "QR Code removed from favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }
