...
public class SecretQRScanHistory extends AppCompatActivity {
    ...
    public void updateScannededQRCode(int qrGenId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(SecretQRScanHistory.this, ScannedQRCodeContentDisplay.class);
    ...
    public void showQRCodeDetails(int QrScanId) {
        QrActionPopUp.dismiss();
        Intent intent = new Intent(SecretQRScanHistory.this, SecretQRScanDetails.class);
    ...
    private void showDialogDelete(int idRecord) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(SecretQRScanHistory.this);
        ...
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(SecretQRScanHistory.this, "Deleted successfully!", Toast.LENGTH_LONG).show();
                    updateRecordListner();
                } catch (Exception e) {
    ...
    private void qrActionPopup(final int position) {
        try {
            ...
            LayoutInflater inflater = (LayoutInflater) SecretQRScanHistory.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            if (secretQrScanId.getFavoriteQr() == 0) {
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(SecretQRScanHistory.this, "QR Code added to favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            } else {
                ...
                addFavoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(SecretQRScanHistory.this, "QR Code removed from favorite list successfully!", Toast.LENGTH_SHORT).show();
                        updateRecordListner();
                    }
                });
            }
