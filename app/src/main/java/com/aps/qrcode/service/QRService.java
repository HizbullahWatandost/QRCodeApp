...
public interface QRService {
    ...
    // the method is used to encrypt the content of QR Code
    String encryptQRCodeContent(String qr_content);

    // the method is used to decrypt the content of QR Code
    String decryptQRCodeContent(String qr_content);

    // this method is used to convert the QR content in a form which is not easy to understand by the user.
    String toNonSenseConverter(String qr_content);

    // this method is used to abstract secret QR encryption key from the QR content
    String getSecretQREncryptionKey(String qr_content);

    // this method is used to remove the encryption key from QR content and return only the content.
    String removeEncryptionKeyFromSecretQR(String qr_content);

    // this method is used to add encryption key to the QR content
